...
(
    ...
    `avatar`               varchar(128) COMMENT 'User avatar URI',
    `background_image`     varchar(128) COMMENT 'User info background image URI',
    `signature`            varchar(128) COMMENT 'User signature',
    `video_count`          bigint unsigned NOT NULL DEFAULT 0 COMMENT 'User video count',
    `favorite_count`       bigint unsigned NOT NULL DEFAULT 0 COMMENT 'User favorite video count',
    `total_favorite_count` bigint unsigned NOT NULL DEFAULT 0 COMMENT 'Count of other users who like this user''s video',
    `follow_count`         bigint unsigned NOT NULL DEFAULT 0 COMMENT 'User follow count',
    `follower_count`       bigint unsigned NOT NULL DEFAULT 0 COMMENT 'User follower count',
...
(
    ...
    `favorite_count` bigint unsigned NOT NULL DEFAULT 0 COMMENT 'Video favorite count',
